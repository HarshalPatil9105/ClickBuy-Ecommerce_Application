...
import com.clickbuy.repository.AddressRepository;
import com.clickbuy.repository.OrderItemRepository;
import com.clickbuy.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
	...
	public Set<Order> createOrder(User user, Address shippingAddress, Cart cart) {
		...
		Map<Long, List<CartItem>> itemsBySellerMap = cart.getCartItems().stream()
